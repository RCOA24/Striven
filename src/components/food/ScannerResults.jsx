...
const ScannerResults = ({ result, onReset }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center pointer-events-none p-2 xs:p-3 sm:p-4 pt-4 sm:pt-0">
      <div className="absolute inset-0 bg-black/50 backdrop-blur-sm pointer-events-auto" onClick={onReset} />
      <div className="relative bg-zinc-900/98 backdrop-blur-xl border border-white/10 rounded-2xl sm:rounded-3xl shadow-2xl animate-in slide-in-from-bottom-10 fade-in duration-300 w-full max-w-2xl max-h-[96vh] sm:max-h-[80vh] flex flex-col pointer-events-auto overflow-hidden">
